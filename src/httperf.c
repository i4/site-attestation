...
static void callbackFreeExtensionRA(SSL *ssl, unsigned int extType,
                                    ...
                                    void *add_arg) {
    char* nonce = SSL_get_ex_data(ssl, RA_SESSION_FLAG_INDEX);
    free(nonce);
}
        ...
        case 0:
            ...
            if (flag == &param.method)
                ...
                *(int *) flag = val;
                ...
                param.rate.dist = DETERMINISTIC;
            } else if (flag == &param.rate.mean_iat) {
                /* --period
                						 */
                param.rate.dist = DETERMINISTIC;
                if (!isdigit(*optarg))
            ...
            else if (flag == &param.tls_server_name)
            {
                ...
                {
                    fprintf (stderr,
                             "%s: Error setting the SNI (Server Name Indication) server name to %s. The --tls-server-name option can only be used if --ssl-protocol-version is set to TLSv1.0 and above.\n",
                             prog_name, optarg);
                    exit (1);
                }
            }
...
bad_wset_param:
    ...
    if (param.use_ssl) {
        ...
        case 4:
            ...
            SSL_CTX_set_options(ssl_ctx,
                                SSL_OP_NO_SSLv2 | SSL_OP_NO_SSLv3 | SSL_OP_NO_TLSv1_1 | SSL_OP_NO_TLSv1_2);
            break;
#endif
        ...
        case 5:
            ...
            ssl_ctx = SSL_CTX_new (TLSv1_client_method ());
            SSL_CTX_set_options(ssl_ctx,
                                SSL_OP_NO_SSLv2 | SSL_OP_NO_SSLv3 | SSL_OP_NO_TLSv1 | SSL_OP_NO_TLSv1_2);
            break;
#endif
        ...
        SSL_CTX_add_custom_ext(ssl_ctx
    ...
    {
    case 0:
        printf (" --ssl-protocol=auto");
        break;
#ifndef OPENSSL_NO_SSL2
    case 2:
        printf (" --ssl-protocol=SSLv2");
        break;
#endif
#ifndef OPENSSL_NO_SSL3
    case 3:
        printf (" --ssl-protocol=SSLv3");
        break;
#endif
    case 4:
        printf (" --ssl-protocol=TLSv1.0");
        break;
    case 5:
        printf (" --ssl-protocol=TLSv1.1");
        break;
    case 6:
        printf (" --ssl-protocol=TLSv1.2");
        break;
#ifdef TLS1_3_VERSION
    case 7:
        printf (" --ssl-protocol=TLSv1.3");
        break;
#endif
    }
#endif
